 ...
 */
class BoxOptInPreprocessor(testServices: TestServices) : ReversibleSourceFilePreprocessor(testServices) {
    val flag = "generated by BoxOptInPreprocessor"
    fun optInString(optIns: Set<String>) = "@OptIn(${optIns.joinToString(", ") { "$it::class" }}) // $flag\n"
    val boxFun = "fun box("
