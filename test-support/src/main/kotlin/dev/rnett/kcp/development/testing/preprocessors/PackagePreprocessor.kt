...
class PackagePreprocessor(testServices: TestServices, val pathPrefix: String = "src/testData") : ReversibleSourceFilePreprocessor(testServices) {

    val flag = "// generated by PackagePreprocessor"
