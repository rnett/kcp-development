 ...
 */
fun TestGroupGeneration.testClassForDirectory(
    relativeRootPath: String,
    testType: TestType,
    suiteTestClassName: String = internal.testClassNamePrefixForDirectory(relativeRootPath) { it == testType.directoryName } + testType.testSuiteName,
...
fun TestGroup.testClassForDirectory(
    relativeRootPath: String,
    testType: TestType,
    suiteTestClassName: String = testClassNamePrefixForDirectory(relativeRootPath) { it == testType.directoryName } + testType.testSuiteName,
    useJunit4: Boolean = false,
    annotations: List<AnnotationModel> = emptyList(),
    recursive: Boolean = true,
    excludeParentDirs: Boolean = false,
...
fun TestGroupGeneration.testClassForDirectory(
    relativeRootPath: String,
    testSpec: TestSpec,
    suiteTestClassName: String = internal.testClassNamePrefixForDirectory(relativeRootPath) + testSpec.badTestSuiteName(),
    useJunit4: Boolean = false,
    annotations: List<AnnotationModel> = emptyList(),
    recursive: Boolean = true,
    excludeParentDirs: Boolean = false,
    ...
    val cls = testSpec.testClass()
    testClass(
        cls,
        suiteTestClassName = suiteTestClassName,
        useJunit4 = useJunit4,
        annotations = annotations + testSpec.annotations(),
    ) {
        model(
...
fun TestGroup.testClassForDirectory(
    relativeRootPath: String,
    testSpec: TestSpec,
    suiteTestClassName: String = testClassNamePrefixForDirectory(relativeRootPath) + testSpec.badTestSuiteName(),
    useJunit4: Boolean = false,
    annotations: List<AnnotationModel> = emptyList(),
    recursive: Boolean = true,
    excludeParentDirs: Boolean = false,
    ...
    val cls = testSpec.testClass().java
    testClass(
        cls,
