...
package dev.rnett.kcp.tests.generated.ir;
...
public class GeneratedIrTestGenerated extends AbstractLeveledIrTest {
  @Override
  ...
  public void testAllFilesPresentInIr() {
    KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("src/testData/generated/ir"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JVM_IR, true);
  }

  @Test
  @TestMetadata("Ir.kt")
  public void testIr() {
    runTest("src/testData/generated/ir/Ir.kt");
  }
}
