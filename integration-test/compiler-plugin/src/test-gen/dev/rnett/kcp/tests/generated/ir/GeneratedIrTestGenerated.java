...
public class GeneratedIrTestGenerated extends AbstractLeveledIrTest {
  ...
  private void run(String fileName) {
    runTest("src/testData/generated/ir/" + fileName);
  }

  @Test
  public void testAllFilesPresentInIr() {
    KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("src/testData/generated/ir"), Pattern.compile("^(.+)\\.kt$"), null, true);
  }
